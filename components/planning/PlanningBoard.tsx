...
export function PlanningBoard({
  ...
  /* Hücre hesabı ORTAK (lib/planning/cells): ay görünümü de aynı gün kartını
     açtığı için aynı veriye ihtiyaç duyuyor. İki kopya tutmak, iki ölçeğin
     sessizce ayrışması demekti. */
  const { byCell, topicRows, rowCountOfSlot, extraSlots } = useMemo(
    () => buildCells(meetings, weekDays, bands),
    [meetings, weekDays, bands],
  );
